...
async def on_ready():
    ...
    activity = discord.Game('Say !startquiz to start a quiz! Contact @McMeny#4263 to add the bot to your server.'))
    print('Bot flashcards_offical is operational!')
...
bot.run('ODYwOTU1NDE5NDQ1NjkwNDA4.GU7A1s.eef1-Q6JleHo-Es2pTSxvpBIqpJ74lKbbrad50')
